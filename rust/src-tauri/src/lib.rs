...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            interface::queries::app_state::app_state_get,
            interface::commands::config::settings_update,
            interface::queries::sessions::get_sessions,
            interface::commands::runtime::listen_start,
            interface::commands::runtime::listen_stop,
            interface::commands::runtime::get_task_status,
            interface::commands::runtime::health_check,
            interface::commands::sidebar::sidebar_start,
            interface::commands::sidebar::sidebar_stop,
            interface::commands::sidebar::live_start,
            interface::commands::sidebar::sidebar_window_open,
            interface::commands::sidebar::sidebar_window_close,
            interface::queries::sidebar::sidebar_snapshot_get,
            interface::commands::sidebar::translate_test,
            interface::commands::sidebar::translate_sidebar_message,
            interface::commands::config::config_get,
            interface::commands::config::config_put,
            interface::commands::config::config_default,
            interface::commands::db_admin::db_clear_restart,
            interface::queries::history::db_query_messages,
            interface::queries::history::db_get_chats,
            ...
            interface::commands::dictionary::get_dict_provider,
            interface::commands::dictionary::translate_cached,
            interface::commands::dictionary::translate_batch,
            interface::commands::dictionary::toggle_favorite,
            interface::commands::dictionary::is_word_favorited,
            interface::commands::dictionary::get_favorites_batch,
            interface::commands::dictionary::list_favorites,
            interface::commands::dictionary::update_favorite_note,
            interface::commands::dictionary::record_review,
            interface::commands::dictionary::count_favorites,
            interface::commands::dictionary::get_words_for_review,
            interface::commands::dictionary::start_review_session,
            interface::commands::dictionary::record_review_feedback,
            interface::commands::dictionary::finish_review_session,
            interface::commands::dictionary::get_review_stats,
            interface::commands::audio::audio_get_url,
